...
QUERIES = {
    "D5": {
        "search": ('"completionism" OR "completionist" OR "achievement hunting" OR '
                   '"achievement hunter" OR "100% completion" OR "platinum trophy" OR '
                   '"collect them all" OR "collectathon"'),
        "filter": ('abstract.search:'
                   '"video game" OR "video games" OR "gaming" OR "gamer" OR '
                   '"rpg" OR "mmorpg" OR "online game" OR "achievement" OR "trophy"'),
    },
}
