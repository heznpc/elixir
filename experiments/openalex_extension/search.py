...
QUERIES = {
    "D2": {
        "search": ('"consumable hoarding" OR "potion hoarding" OR "elixir" OR '
                   '"too good to use" OR "item retention" OR "resource hoarding"'),
        "filter": ('abstract.search:'
                   '"video game" OR "video games" OR "gaming" OR "gamer" OR '
                   '"rpg" OR "mmorpg" OR "online game"'),
    },
    "D6": {
        "search": ('"backlog" OR "pile of shame" OR "unplayed games" OR '
                   '"steam library" OR "game library"'),
        "filter": ('abstract.search:'
                   '"video game" OR "video games" OR "gaming" OR "gamer" OR '
                   '"steam" OR "digital storefront"'),
    },
}
